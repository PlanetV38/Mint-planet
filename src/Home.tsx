            ...
            <MainContainer>
                ...
                <Logo><a href="https://www.mintplanet-38.art/" target="_blank" rel="noopener noreferrer"><img alt=""
                    ...
                    <Menu>
                        ...
                        <li><a href="https://discord.gg/n6gHmS3x" target="_blank" rel="noopener noreferrer">Discord</a>
                        </li>
                        <li><a href="https://discord.gg/n6gHmS3x" target="_blank"
                ...
                <ShimmerTitle>early sale live!</ShimmerTitle>
                <br/>
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            <h2>Panvori from the planet-38</h2>
                            <br/>
                            <div><Price
                    ...
                    <DesContainer>
                        ...
                        <LogoAligner><img src="logo.png" alt=""></img><GoldTitle>Road map</GoldTitle></LogoAligner>
                            <p>1.Think over and register the history of the universe.
                                           </p>
                            <p>2.Creation of social networks for our community twitter and discord.
                                           </p>
                            <p>3.launch a public sale.</p>
                            <p>4.Release of a teaser of our future game.</p>
                            <p>5.Release of the first comic book to familiarize with the universe.</p>
                            <p>6.Demo version of the game and the launch of the $vori token.</p>
                            <p>7.Distribution of gifts.</p>
                            <p>8.Release of the game to the masses.</p>
